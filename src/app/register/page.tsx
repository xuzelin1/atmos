    ...
    <div className="min-h-screen flex">
          ...
          <div className="flex items-center gap-2 mb-10">
            <div className="flex -space-x-2">
              {["🤖", "🔍", "💻"].map((emoji, i) => (
                <div
                  key={i}
                  className="w-12 h-12 rounded-full border-2 border-white bg-white flex items-center justify-center text-xl shadow-sm"
                  style={{ zIndex: 3 - i }}
                >
                  {emoji}
                </div>
            ...
            <span className="text-sm text-slate-600 font-medium ml-3">
              询问 Alex 快速构建原型
            </span>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-slate-900 mb-2">创建你的账号</h1>
            <p className="text-slate-500 text-sm">免费开始，无需信用卡</p>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-4 text-slate-400">或使用邮箱注册</span>
            </div>
          </div>
